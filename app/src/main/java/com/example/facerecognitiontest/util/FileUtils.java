package com.example.facerecognitiontest.util;
...
public class FileUtils {
    ...
    public static final String DATA_FILE_PB = "PB_data";
    public static final String DATA_FILE_MOBILE = "Mobile_data";
    public static final String DATA_FILE_TF = "TF_data";
